...
def Wechat(title,content):
    api = "https://sc.ftqq.com/SCU119479T3cc3eed2e16cff38a565bf9a3033a0ab5f904d4048e25.send"    data = {
    "text" : title,
    "desp" : content
    }
    ...
    def login(self):
            ...
            try:
                ...
                # if '1' in init_text:
                    ...
                    wait(wd, 10, poll_frequency=0.5).until(ec.element_to_be_clickable((By.XPATH, '//*[@id="bak_0"]/div[11]/div[4]/span'))).click()
